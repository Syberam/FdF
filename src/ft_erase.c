...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/06/13 16:10:29 by sbonnefo          #+#    #+#             */
/*   Updated: 2017/06/13 16:10:49 by sbonnefo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	param->data[4 * (y * (par.w * 2) + x) + 0] = 0x000000 >> 0;
	param->data[4 * (y * (par.w * 2) + x) + 1] = 0x000000 >> 8;
	param->data[4 * (y * (par.w * 2) + x) + 2] = 0x000000 >> 16;
	param->data[4 * (y * (par.w * 2) + x) + 3] = 0x000000 >> 24;
}

static void	ft_peaks_to_img(t_peak *start, int col, t_mlx *param)
{
	param->data[4 * ((int)start->yy * param->w * 2
								+ (int)start->xx) + 0] = 0x000000 >> 0;
	param->data[4 * ((int)start->yy * param->w * 2
								+ (int)start->xx) + 1] = 0x000000 >> 8;
	param->data[4 * ((int)start->yy * param->w * 2
								+ (int)start->xx) + 2] = 0x000000 >> 16;
	param->data[4 * ((int)start->yy * param->w * 2
								+ (int)start->xx) + 3] = 0x000000 >> 24;
}
